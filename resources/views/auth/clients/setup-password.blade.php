...
<head>
    ...
    <title>إنشاء كلمة المرور — Red Sea Digital Pro</title>
...
<body>
    <div class="setup-card">
        <div class="brand-container">
            ...
            <div class="brand-title">Client Dashboard</div>
        </div>

        <h1>إنشاء كلمة المرور</h1>
        <p class="lead">اختر كلمة مرور قوية لحسابك في بوابة العملاء</p>
        ...
        <form method="POST" action="{{ url('/client/setup-password/' . $token) }}">
            @csrf

            <div class="form-group">
                <label for="password">كلمة المرور</label>
                <input type="password" id="password" name="password" placeholder="••••••••" required minlength="8" dir="ltr">
                @error('password') <div class="error-text">{{ $message }}</div> @enderror
            </div>

            <div class="form-group">
                <label for="password_confirmation">تأكيد كلمة المرور</label>
                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="••••••••" required minlength="8" dir="ltr">
            </div>

            <ul class="requirements">
                <li>حد أدنى 8 أحرف</li>
                <li>استخدم مزيجاً من الأحرف والأرقام</li>
                <li>كلمة المرور مشفرة بالكامل — نحن لا نراها أبداً</li>
            </ul>

            <button type="submit" class="btn">تفعيل الحساب والدخول</button>
        </form>
    </div>
</body>
</html>
