...
<head>
    ...
    <title>تسجيل دخول العملاء — Red Sea Digital Pro</title>
    ...
    <div class="login-card">
        ...
        <form method="POST" action="{{ route('client.authenticate') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="name@company.com" required autofocus dir="ltr">
        ...
        <div class="footer-link">
            ليس لديك مشروع حالياً؟ <a href="{{ route('apply') }}">احجز تشخيصك الرقمي</a>
        </div>
    </div>
</body>
</html>
